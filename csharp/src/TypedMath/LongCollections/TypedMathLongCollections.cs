...
public static class TypedMathLongCollections
{
    ...
    /// </remarks>
    public static long[] DecreaseAllValuesWith(this long[] array, long dec) => [.. array.Select(x => x - dec)];
    ...
    public static double GetAverage(this long[] array) => array.Average(x => (double)x);
    ...
    /// </remarks>
    public static long[] GetFirstHalf(this long[] array) => [.. array.Take(array.Length / 2)];
    ...
    public static long GetFirstValue(this long[] array) => array.First();
    ...
    /// </remarks>
    public static long[] GetLastHalf(this long[] array) => [.. array.Skip(array.Length / 2).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static long GetLastValue(this long[] array) => array.Last();
    ...
    /// </remarks>
    public static long[] GetMiddle(this long[] array) => [.. array.Skip(array.Length / 4).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static long GetMiddleValue(this long[] array) => array[array.Length / 2];
    ...
    public static long[] GetValuesHigherThan(this long[] array, long x) => [.. array.Where(y => y >= x)];
    ...
    public static long[] GetValuesLowerThan(this long[] array, long x) => [.. array.Where(y => y <= x)];
    ...
    /// </remarks>
    public static long[] IncreaseAllValuesWith(this long[] array, long add) => [.. array.Select(x => x + add)];
    ...
    public static long[] SortArrayAsc(this long[] array) => [.. array.OrderBy(x => x)];
    ...
    public static long[] SortArrayDesc(this long[] array) => [.. array.OrderByDescending(x => x)];
