...
public static class TypedMathNuintCollections
{
    ...
    /// </remarks>
    public static nuint[] DecreaseAllValuesWith(this nuint[] array, nuint dec) => [.. array.Select(x => x - dec)];
    ...
    public static double GetAverage(this nuint[] array) => array.Average(x => (double)x);
    ...
    /// </remarks>
    public static nuint[] GetFirstHalf(this nuint[] array) => [.. array.Take(array.Length / 2)];
    ...
    public static nuint GetFirstValue(this nuint[] array) => array.First();
    ...
    public static nuint GetHighestValue(this nuint[] array) => array.Max();
    ...
    /// </remarks>
    public static nuint[] GetLastHalf(this nuint[] array) => [.. array.Skip(array.Length / 2).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static nuint GetLastValue(this nuint[] array) => array.Last();
    ...
    public static nuint GetLowestValue(this nuint[] array) => array.Min();
    ...
    /// </remarks>
    public static nuint[] GetMiddle(this nuint[] array) => [.. array.Skip(array.Length / 4).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static nuint GetMiddleValue(this nuint[] array) => array[array.Length / 2];
    ...
    public static nuint[] GetValuesHigherThan(this nuint[] array, nuint x) => [.. array.Where(y => y >= x)];
    ...
    public static nuint[] GetValuesLowerThan(this nuint[] array, nuint x) => [.. array.Where(y => y <= x)];
    ...
    /// </remarks>
    public static nuint[] IncreaseAllValuesWith(this nuint[] array, nuint add) => [.. array.Select(x => x + add)];
    ...
    public static nuint[] SortArrayAsc(this nuint[] array) => [.. array.OrderBy(x => x)];
    ...
    public static nuint[] SortArrayDesc(this nuint[] array) => [.. array.OrderByDescending(x => x)];
    ...
    public static nuint SumAllValues(this nuint[] array) => (nuint)array.Sum(x => (int)x);
}
