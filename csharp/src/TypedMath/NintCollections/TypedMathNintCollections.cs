...
public static class TypedMathNintCollections
{
    ...
    /// </remarks>
    public static nint[] DecreaseAllValuesWith(this nint[] array, nint dec) => [.. array.Select(x => x - dec)];
    ...
    public static double GetAverage(this nint[] array) => array.Average(x => (double)x);
    ...
    /// </remarks>
    public static nint[] GetFirstHalf(this nint[] array) => [.. array.Take(array.Length / 2)];
    ...
    public static nint GetFirstValue(this nint[] array) => array.First();
    ...
    public static nint GetHighestValue(this nint[] array) => array.Max();
    ...
    /// </remarks>
    public static nint[] GetLastHalf(this nint[] array) => [.. array.Skip(array.Length / 2).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static nint GetLastValue(this nint[] array) => array.Last();
    ...
    public static nint GetLowestValue(this nint[] array) => array.Min();
    ...
    /// </remarks>
    public static nint[] GetMiddle(this nint[] array) => [.. array.Skip(array.Length / 4).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static nint GetMiddleValue(this nint[] array) => array[array.Length / 2];
    ...
    public static nint[] GetValuesHigherThan(this nint[] array, nint x) => [.. array.Where(y => y >= x)];
    ...
    public static nint[] GetValuesLowerThan(this nint[] array, nint x) => [.. array.Where(y => y <= x)];
    ...
    /// </remarks>
    public static nint[] IncreaseAllValuesWith(this nint[] array, nint add) => [.. array.Select(x => x + add)];
    ...
    public static nint[] SortArrayAsc(this nint[] array) => [.. array.OrderBy(x => x)];
    ...
    public static nint[] SortArrayDesc(this nint[] array) => [.. array.OrderByDescending(x => x)];
    ...
    public static nint SumAllValues(this nint[] array) => (nint)array.Sum(x => (int)x);
}
