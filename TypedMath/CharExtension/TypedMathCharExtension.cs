...
public static class TypedMathCharExtension
{
    ...
    public static int[] ConvertArrayToInt(this char[] array) => [.. array.Select(x => (int)x)];
    ...
    /// <param name="array">An array of <see cref="char"/> values.</param>
    /// <returns>The result of the operation</returns>
    public static char GetLastValue(this char[] array) => array[^1];
    ...
    /// </summary>
    /// <param name="array">A <see cref="char"/> array.</param>
