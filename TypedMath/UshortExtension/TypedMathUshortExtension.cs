...
public static class TypedMathUshortExtension
{
    ...
    /// <returns>The array of <see cref="int"/></returns>
    public static int[] ConvertArrayToInt(this ushort[] array) => [.. array.Select(x => (int)x)];
    ...
    /// <returns>The result of the operation</returns>
    public static ushort GetLastValue(this ushort[] array) => array[^1];
