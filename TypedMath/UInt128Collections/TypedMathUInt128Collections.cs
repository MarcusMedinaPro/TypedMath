...
public static class TypedMathUInt128Collections
{
    ...
    /// </remarks>
    public static UInt128[] DecreaseAllValuesWith(this UInt128[] array, UInt128 dec) => [.. array.Select(x => x - dec)];
    ...
    public static double GetAverage(this UInt128[] array) => array.Average(x => (double)x);
    ...
    /// </remarks>
    public static UInt128[] GetFirstHalf(this UInt128[] array) => [.. array.Take(array.Length / 2)];
    ...
    public static UInt128 GetFirstValue(this UInt128[] array) => array.First();
    ...
    public static UInt128 GetHighestValue(this UInt128[] array) => array.Max();
    ...
    /// </remarks>
    public static UInt128[] GetLastHalf(this UInt128[] array) => [.. array.Skip(array.Length / 2).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static UInt128 GetLastValue(this UInt128[] array) => array.Last();
    ...
    public static UInt128 GetLowestValue(this UInt128[] array) => array.Min();
    ...
    /// </remarks>
    public static UInt128[] GetMiddle(this UInt128[] array) => [.. array.Skip(array.Length / 4).Take(array.Length / 2)];
    ...
    /// </remarks>
    public static UInt128 GetMiddleValue(this UInt128[] array) => array[array.Length / 2];
    ...
    public static UInt128[] GetValuesHigherThan(this UInt128[] array, UInt128 x) => [.. array.Where(y => y >= x)];
    ...
    public static UInt128[] GetValuesLowerThan(this UInt128[] array, UInt128 x) => [.. array.Where(y => y <= x)];
    ...
    /// </remarks>
    public static UInt128[] IncreaseAllValuesWith(this UInt128[] array, UInt128 add) => [.. array.Select(x => x + add)];
    ...
    public static UInt128[] SortArrayAsc(this UInt128[] array) => [.. array.OrderBy(x => x)];
    ...
    public static UInt128[] SortArrayDesc(this UInt128[] array) => [.. array.OrderByDescending(x => x)];
    ...
    public static UInt128 SumAllValues(this UInt128[] array) => (UInt128)array.Sum(x => (int)x);
}
